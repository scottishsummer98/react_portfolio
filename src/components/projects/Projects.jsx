...
import mernecom1 from "../../assets/mernecom1.jpg";
import mernecom2 from "../../assets/mernecom2.jpg";
import mernecom3 from "../../assets/mernecom3.jpg";
import mernecom4 from "../../assets/mernecom4.jpg";
import mernecom5 from "../../assets/mernecom5.jpg";
...
const data = [
  {
    ...
    details:
      "An ecommerce website with admin CRUD accesibilities of categories, products,coupons. User can order products, give reviews of products. Payment with SSL integrated and social login with both google and facebook enabled",
    github: "https://github.com/scottishsummer98/mern_ecom_backend",
    demo: "https://mernecom.netlify.app/",
  },
  {
    id: 2,
    image1: ims1,
